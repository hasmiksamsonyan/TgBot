...
namespace TelegramBot
{
    ...
    {
        // ============================================================
        // ГЛОБАЛЬНЫЕ ПЕРЕМЕННЫЕ (ПОЛЯ КЛАССА)
        // ============================================================
        static string userName = null;
        static List<string> tasks = new List<string>();

        // Ограничения (запрашиваем у пользователя при старте)
        static int maxTaskCount = 0;      // Максимальное количество задач
        static int maxTaskLength = 0;     // Максимальная длина задачи

        // ============================================================
        // ТОЧКА ВХОДА В ПРОГРАММУ С ГЛОБАЛЬНЫМ TRY-CATCH
        // ============================================================
